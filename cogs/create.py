            ...
            if len(args) >= 4:
                ...
                if regex is not None:
                    ...
                    if "errors" in result:
                        ...
                        embed.add_field(name="Diğer", value="**Site:** [Tıkla](https://nightservers.xyz/)", inline=True)
                        embed.add_field(name="​", value="**Panel:** [Tıkla](https://panel.nightservers.xyz/)\n**Durum:** [Tıkla](https://uptime.nightservers.xyz/)", inline=True)
                ...
                embed = discord.Embed(description=f"Kullanım !create <etiket> <eposta> <k.adı> <şifre>", color=0xfc0303)
                await ctx.channel.send(embed=embed)
                pass
        else:
